...
function [f] = one_k_one_beta_linear(p,chosen,effort,reward,agent,stim_props,outtype)% same as in models above in same order
% p(1) = k 
% p(2) = beta
...
%%%% Model -linear devalue reward by effort. 1 parameter for both
%%%% conditions
